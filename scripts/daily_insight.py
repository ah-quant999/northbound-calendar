...
def generate_html(market_temp: dict, jiyou_insight: dict, nb_insight: dict,
    ...
    temp_color = temp_colors.get(market_temp["level"], "#58a6ff")
...
<head>
    ...
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .legend-dot.temp {{ background: #58a6ff; }}
        .legend-dot.jiyou {{ background: #f85149; }}
        .legend-dot.nb {{ background: #3fb950; }}
        .legend-dot.focus {{ background: #d29922; }}
        .update-time {{
            text-align: center;
            color: #6e7681;
            font-size: 11px;
        ...
        .section-label.industry {{ color: #d29922; }}
        ...
        /* 行业高亮 */
        .industry-highlight {{
            background: linear-gradient(90deg, rgba(210, 153, 34, 0.1) 0%, rgba(210, 153, 34, 0.02) 100%);
...
<div class="container">
    ...
    <div class="footer">
        数据来源：龙虎榜机游信号 &amp; 北向席位资金 &nbsp;|&nbsp;
        <a href="jiyou-signal-analysis.html">机游信号分析</a> &nbsp;·&nbsp;
        <a href="northbound-analysis.html">北向资金分析</a>
    </div>
</div>
</body>
</html>"""
