...
def generate_month_html(year, month, today_date=None):
    ...
    lines.append('        <div class="nav-bar" style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:8px;">')
    ...
    lines.append('            <div style="display:flex;align-items:center;gap:16px;flex-shrink:0;">')
    ...
    lines.append('            <h1 style="margin:0;">重要日历</h1>')
