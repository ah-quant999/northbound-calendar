...
<div class="container">
    ...
    <div class="section">
        <div class="params">
            ...
            <div class="param-item"><span class="label">TOP行业数</span><span class="value">TOP{config['top_n_industries']}</span></div>
            <div class="param-item"><span class="label">行业门槛</span><span class="value">≥{config['min_stock_per_industry']}只净买入上榜</span></div>
            <div class="param-item"><span class="label">总信号数</span><span class="value">{sum(d.get('sample_count',0) for d in overall.values()) // len(overall) if overall else 0}</span></div>
...
if __name__ == "__main__":
    generate_page("data/northbound_industry_backtest.json", "northbound-industry-backtest.html")
