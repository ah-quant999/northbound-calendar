...
def generate_month_html(year, month, today_date=None):
    ...
    prev_label = f"{prev_m}月"
    next_label = f"{next_m}月"
    ...
    HOLIDAY_CLASSES = {'hk-holiday', 'us-holiday', 'sg-holiday', 'cn-holiday', 'fomc'}
    seen = {}
    deduped = []
    ...
    lines.append('            box-shadow: 0 4px 14px rgba(201,177,255,0.4);')
    lines.append('        }')
    ...
    lines.append('            <a href="portal.html" class="nav-back-btn"><svg width="18" height="18" viewBox="0 0 20 20" style="flex-shrink:0"><rect x="2" y="3" width="16" height="15" rx="2" fill="#e2534b"/><rect x="2" y="1" width="16" height="3" rx="1" fill="#fff" opacity="0.95"/><rect x="5" y="7" width="4" height="2" rx="0.5" fill="#fff" opacity="0.6"/><rect x="11" y="7" width="4" height="2" rx="0.5" fill="#fff" opacity="0.6"/><rect x="5" y="11" width="4" height="2" rx="0.5" fill="#fff" opacity="0.6"/><rect x="11" y="11" width="4" height="2" rx="0.5" fill="#fff" opacity="0.6"/><circle cx="15" cy="4" r="1.5" fill="#e2534b"/></svg>返回九宝日历精选</a>')
    ...
    lines.append(f'                    <span class="nav-month-current"><strong>{month_name}</strong> · 全市场重要事件一览</span>')
    ...
    lines.append('            </div>')
    lines.append('            <div class="nav-spacer"><a href="portal.html" class="nav-back-btn" style="pointer-events:none"><svg width="18" height="18" viewBox="0 0 20 20" style="flex-shrink:0"><rect x="2" y="3" width="16" height="15" rx="2" fill="#e2534b"/><rect x="2" y="1" width="16" height="3" rx="1" fill="#fff" opacity="0.95"/><rect x="5" y="7" width="4" height="2" rx="0.5" fill="#fff" opacity="0.6"/><rect x="11" y="7" width="4" height="2" rx="0.5" fill="#fff" opacity="0.6"/><rect x="5" y="11" width="4" height="2" rx="0.5" fill="#fff" opacity="0.6"/><rect x="11" y="11" width="4" height="2" rx="0.5" fill="#fff" opacity="0.6"/><circle cx="15" cy="4" r="1.5" fill="#e2534b"/></svg>返回九宝日历精选</a></div>')
    lines.append('        </div>')
    lines.append('    </div>')
    lines.append('')
    lines.append('    <!-- 分类标签导航 -->')
